...
![QQ截图20210914154509.png](https://www.leyuna.xyz/image/2021-09-14/QQ截图20210914154509.png)width="auto" height="auto"}}}

这是最常用的思路，不难，就是循环遍历字符串的过程中，判断其是否是数字或是操作符，然后将其压入对应栈里进行判断。
不过在只是翻译的前提下，我推荐使用括号法。
#### 括号法
![QQ截图20210914155926.png](https://www.leyuna.xyz/image/2021-09-14/QQ截图20210914155926.png)width="auto" height="auto"}}}
