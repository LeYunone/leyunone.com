...
那么跟着这三点我们可以得到常见的一个名称：**分片上传**![emo](https://www.leyuna.xyz/image/emo/QQ图片20220302210445.jpg)
## 分片上传
在第三点我们提到：小文件 = 分片。
...
:::align-center
![data.png](https://www.leyuna.xyz/image/2022-04-21/data.png)
:::
...
:::align-center
![jiaoy.png](https://www.leyuna.xyz/image/2022-04-22/jiaoy.png)
:::
...
都会导致断点下载不稳定的出现异常。
![ddxc.png](https://www.leyuna.xyz/image/2022-04-22/ddxc.png)
## 小文件处理
以上，不管是断点续传还是分片。
